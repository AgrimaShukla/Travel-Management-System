...
def test_update_in_itinerary(mocker, itinerary_fixture):
    ...
    input_data = ['str', '2']
    mocker.patch('builtins.input', lambda a: input_data.pop(0))
...
def test_print_update_in_itinerary(mocker, itinerary_fixture, capsys):
