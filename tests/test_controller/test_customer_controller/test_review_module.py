...
def test_add_review(mocker, review_test):
...
def test_show_review(review_test, capsys):
...
def test_show_data(mocker, review_test, capsys):
...
def test_show_no_data(review_test, capsys):
