...
class AddBookingController:
    def create_booking(self, booking_data):
        ...
        user_details = (name, mobile_number, start_date, number_of_people, email)
        trip_details = (package_id, user_id, 'active')
        total_price = BookingHandler().add_booking(user_details, trip_details, days_night, price)
        return CustomSuccessResponse(StatusCodes.CREATED, PrintPrompts.BOOKED_SUCCESSFULLY.format(total_price))